...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train SAC on PandaPush-v3 without HER")
    ...
    parser.add_argument(
        ...
        type=str,
        default="auto",
        help='Entropy coefficient. Examples: "auto", "auto_0.1", "0.01", "0.05"',
    )
...
def parse_ent_coef(ent_coef: str) -> Union[str, float]:
    if ent_coef.startswith("auto"):
        return ent_coef
...
def main() -> None:
    ...
    ent_coef_value = parse_ent_coef(args.ent_coef)
    ...
    if args.sampling_strategy == "udr":
        mass_info = f"mass_{mass_min_str}_{mass_max_str}_"
